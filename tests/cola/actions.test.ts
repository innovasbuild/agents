...
// webSendDeps se declara antes del import dinámico: vi.mock se hoistea por
// encima de todo el archivo, así que cuando el import de abajo dispara la
// factory de este mock, necesita que webSendDeps ya esté inicializado (si no,
// TDZ: "Cannot access 'webSendDeps' before initialization").
